<?php
/**
 * Customised version of the Deployer shared.php recipe to allow customising the share folder.
 * Import after importing the original recipe.
 */
namespace Deployer;
...
task('deploy:shared', function () {
    $sharedPath = get("shared_path", "{{deploy_path}}/shared");
